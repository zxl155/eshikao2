...
$mchid = '1508009641';   //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wxb7c95914eaa62229'; //微信支付申请对应的公众号的APPID
$appKey = '371325198602104558jiayanqing088x'; //微信支付申请对应的公众号的APP Key
$apiKey = '097703e137eba3b2f6e2737ed1089af7'; //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
...
$orderName = '支付测试'; //订单标题
$notifyUrl = 'http://www.eshikao.com/';  //付款成功后的回调地址(不要有问号)
$payTime = time();  //付款时间
