...
class AopClient {
	...
	*/
	...
	public function checkSignAndalipayDecrypt($params, $rsaPublicKeyPem, $rsaPrivateKeyPem, $isCheckSign, $isalipayDecrypt) {
		...
		if ($isalipayDecrypt) {
			return $this->rsaalipayDecrypt($bizContent, $rsaPrivateKeyPem, $charset);
		}
	...
	public function rsaalipayDecrypt($data, $rsaPrivateKeyPem, $charset) {
		//读取私钥文件
