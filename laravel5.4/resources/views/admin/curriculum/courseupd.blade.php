        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" action="{{ url('admin/courseupds') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <span><input type="hidden" name="curriculum_id" value="{{$data[0]->curriculum_id}}"></span>
                        <span><input type="hidden" name="curriculum_ids" value="{{$curriculum_ids}}"></span>
