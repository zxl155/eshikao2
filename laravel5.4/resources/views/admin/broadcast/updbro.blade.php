                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="{{ url('admin/updsbro') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="broadcast_id" value="{{ $data->broadcast_id }}">
