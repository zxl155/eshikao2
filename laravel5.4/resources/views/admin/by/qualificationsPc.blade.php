...
<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        ...
        <li><a href="#">课程排序</a></li>
        <li class="am-active">PC教师资格证排序</li>
    </ol>
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span>PC教师资格证排序列表
            </div>
                ...
                <div class="am-u-sm-12">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tbody>
                                ...
                                <form action="{{ url('admin/qualificationsPcSearch') }}" method="post">
                                    {{ csrf_field() }}
                                    <tr>
                                        ...
                                        <th>
                                            @if($value->home_page=='0')
                                                <span style="color: red">否</span>(<a href="qualificationsHomePage?curriculum_id={{$value->curriculum_id}}"  style="color:blue">点击</a>进行修改)
                                            @else
                                                <span style="color:blue">是</span>(<a href="qualificationsHomePage?curriculum_id={{$value->curriculum_id}}" style="color:blue">点击</a>进行修改)
                                            @endif
                                        </th>
                                    </tr>
                                </form>
