...
class Curriculum extends Model
{
     ...
     */
     public function insert($data){
        ...
        $arr = DB::insert('insert into curriculum (curriculum_pricture,curriculum_name,purchase_number,original_price,recovery_original,present_price,purchase_state_time,purchase_end_time,teacher_type,type_id,subject_id,grade_id,admin_id,notice,qq_group_key,publish,region_id,curriculum_content,is_goods) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',[$data['curriculum_pricture'],$data['curriculum_name'],$data['purchase_number'],$data['original_price'],$data['recovery_original'],$data['present_price'],$data['purchase_state_time'],$data['purchase_end_time'],$data['teacher_type'],$data['type_id'],$data['subject_id'],$data['grade_id'],$data['admin_id'],$data['notice'],$data['qq_group_key'],$data['publish'],$data['region_id'],$data['curriculum_content'],$data['is_goods']]);
       if ($arr) {
           return true;
       } else {
          return false;
