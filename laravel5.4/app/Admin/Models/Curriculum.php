...
class Curriculum extends Model
{
     ...
     */
     public function insert($data){
        ...
        $arr = DB::insert('insert into curriculum (curriculum_pricture,curriculum_name,purchase_number,original_price,recovery_original,present_price,purchase_state_time,purchase_end_time,teacher_type,type_id,subject_id,grade_id,admin_id,notice,qq_group_key,publish,region_id,curriculum_content,is_goods,qq_number,video) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',[$data['curriculum_pricture'],$data['curriculum_name'],$data['purchase_number'],$data['original_price'],$data['recovery_original'],$data['present_price'],$data['purchase_state_time'],$data['purchase_end_time'],$data['teacher_type'],$data['type_id'],$data['subject_id'],$data['grade_id'],$data['admin_id'],$data['notice'],$data['qq_group_key'],$data['publish'],$data['region_id'],$data['curriculum_content'],$data['is_goods'],$data['qq_number'],$data['video']]);
       if ($arr) {
           return true;
       } else {
          return false;
    ...
    public function upd($data){
      ...
      if(isset($data['curriculum_pricture'])){
        $arr = DB::table('curriculum')->where('curriculum_id','=',$data['curriculum_id'])->update(['curriculum_name'=>$data['curriculum_name'],'purchase_number'=>$data['purchase_number'],'original_price'=>$data['original_price'],'recovery_original'=>$data['recovery_original'],'present_price'=>$data['present_price'],'purchase_state_time'=>$data['purchase_state_time'],'purchase_end_time'=>$data['purchase_end_time'],'teacher_type'=>$data['teacher_type'],'type_id'=>$data['type_id'],'subject_id'=>$data['subject_id'],'grade_id'=>$data['grade_id'],'region_id'=>$data['region_id'],'admin_id'=>$data['admin_id'],'notice'=>$data['notice'],'qq_group_key'=>$data['qq_group_key'],'publish'=>$data['publish'],'curriculum_content'=>$data['curriculum_content'],'curriculum_pricture'=>$data['curriculum_pricture'],'is_goods'=>$data['is_goods'],'qq_number'=>$data['qq_number'],'video'=>$data['video']]);
      } else {
        $arr = DB::table('curriculum')->where('curriculum_id','=',$data['curriculum_id'])->update(['curriculum_name'=>$data['curriculum_name'],'purchase_number'=>$data['purchase_number'],'original_price'=>$data['original_price'],'recovery_original'=>$data['recovery_original'],'present_price'=>$data['present_price'],'purchase_state_time'=>$data['purchase_state_time'],'purchase_end_time'=>$data['purchase_end_time'],'teacher_type'=>$data['teacher_type'],'type_id'=>$data['type_id'],'subject_id'=>$data['subject_id'],'grade_id'=>$data['grade_id'],'region_id'=>$data['region_id'],'admin_id'=>$data['admin_id'],'notice'=>$data['notice'],'qq_group_key'=>$data['qq_group_key'],'publish'=>$data['publish'],'curriculum_content'=>$data['curriculum_content'],'is_goods'=>$data['is_goods'],'qq_number'=>$data['qq_number'],'video'=>$data['video']]);
      }
        if($arr){
            return true;
        }else{
